...
function Button({ children, variant, onClick, oneGridDisplay }) {
  const classVariation = {
    ...
    AddCart: `py-2 px-5 ${oneGridDisplay ? 'w-[35%]' : 'w-[80%]'} mx-auto rounded-md border border-customBlack focus:bg-orangeCustom hover:bg-orangeCustom focus:border-orangeCustom hover:border-orangeCustom focus:text-white hover:text-white`,
